...
<![endif]-->
		...
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/jquery.dataTables.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/jquery.dataTables.bootstrap.js"></script>
