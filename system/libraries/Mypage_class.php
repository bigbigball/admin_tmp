...
class Mypage_class {
    ...
    */
    ...
    public $seg=4;//页码参数取 index.php之后的段数，默认为3，即index.php/control/function/18 这种形式
     ...
     public function __construct($params = array())
        ...
        function initialize($params)
        {
            if (count($params) > 0)
            {
                ...
                $this->seg=isset($params['seg']) ? $params['seg'] : 4;//页码参数取 index.php之后的段数，默认为3，即index.php/control/function/18 这种形式
