...
<![endif]-->
		...
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/jquery.easypiechart.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/jquery.sparkline.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/flot/jquery.flot.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/flot/jquery.flot.pie.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/flot/jquery.flot.resize.js"></script>
		...
		<link rel="stylesheet" href="<?php echo base_url().'style/admin/' ?>assets/js/themes/sunburst.css" />
		...
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/rainbow.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/language/generic.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/language/html.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/language/css.js"></script>
		<script src="<?php echo base_url().'style/admin/' ?>assets/js/language/javascript.js"></script>
	</body>
</html>
